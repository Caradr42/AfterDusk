...
/**
 * Component of the player as an entity This is the class player. Here we have
 * all the variables needed for the player. Since it is an entity of the
 * entity-component-system model, it does not need anything else. The player
 * just have by itself; weapons, energy, HP, actives, passives, and a name
 *
...
public class Player extends Component {
     ...
     * @param name
     * @param LRInventory
     * @param pasivesInventory
     * @param activesInventory
     * @param uiText
     * @param idAttack
     */
